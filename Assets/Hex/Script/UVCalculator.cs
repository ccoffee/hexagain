...
public class UvCalculator
{
	...
	public static Vector2[] CalculateUVs(Vector3[] v/*vertices*/, float scale)
	{
		...
		for (int i = 0; i < uvs.Length; i += 3)
		{
			...
			Vector3 offsetVertex = new Vector3(HexMetrics.outerRadius, 0, HexMetrics.outerRadius);

			Vector3 v0 = v[i0] + offsetVertex;
			Vector3 v1 = v[i1] + offsetVertex;
			Vector3 v2 = v[i2] + offsetVertex;
